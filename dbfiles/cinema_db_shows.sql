...
CREATE TABLE `shows` (
  ...
  PRIMARY KEY (`cinema_name`,`city`,`dt_start`,`movie_id`),
  CONSTRAINT `Fk_shows` FOREIGN KEY (`cinema_name`, `city`) REFERENCES `Cinemas` (`cinema_name`, `city`)
...
-- Dump completed on 2021-09-19 21:16:18
